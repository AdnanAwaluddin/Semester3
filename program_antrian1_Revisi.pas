...
{prosedure hapusdpn digunakan untuk menghapus list dalam antrian}
...
procedure cetak(depan:antrian; var output:string); var bantu:antrian; y:string;
begin
bantu:= depan;
...
writeln('Antrian dilanjutkan hariberikutnya');
exit;
end;
end;
until (pil='8');
